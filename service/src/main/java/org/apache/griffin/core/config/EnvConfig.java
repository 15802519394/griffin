...
public class EnvConfig {
    ...
    public static void main(String[] args) throws IOException {
        String path1 = "data/_accuracy-batch-griffin_real.json";
        String result1 = readEnvFromResource(path1);
        System.out.println("readEnvFromResource=========================="+result1);

        String path2 = "E:\\ls\\work\\work_github\\griffin\\measure\\target\\test-classes\\_accuracy-batch-griffin_real.json";
        String result2 = readEnvFromAbsolutePath(path2);
        System.out.println("readEnvFromAbsolutePath============================="+result2);
    }
     ...
     */
    public static String readEnvFromResource(String path)
            throws IOException {
        if (path == null) {
     ...
     * @throws IOException io exception
     */
    public static String readEnvFromAbsolutePath(String path)
            throws IOException {
        if (path == null) {
            LOGGER.warn("Parameter path is null.");
            return null;
